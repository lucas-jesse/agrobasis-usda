...
.card {
    ...
    border-left:4px solid var(--accent, #14532d);
...
PALETA = ["#14532d", "#15a86b", "#0b3d63", "#c2730f", "#0891b2",
...
with tabs[1]:
    ...
    attrs_oferta_demanda = ["Total Supply", "Domestic Consumption"]
    ...
    fig_bal = px.bar(
        ...
        color_discrete_map={"Oferta Total": "#14532d", "Consumo Doméstico": "#c2730f"}
    )
    aplicar_rotulos_barra(fig_bal, casas=1, mostrar_rotulos=mostrar_rotulos_periodo)
...
with tabs[2]:
    ...
    with c1:
        ...
        fig_ms_top.update_traces(marker_color="#14532d")
        aplicar_rotulos_barra(fig_ms_top, casas=1, orientacao="h")
...
with tabs[5]:
    ...
    if not conc.empty:
        ...
        fig_conc.update_traces(marker_color="#14532d", textposition="outside", textfont=dict(size=12, color="#334155"), cliponaxis=False)
