...
with tabs[0]:
    ...
    with col_b:
        ...
        <div class="insight-box">
            ...
            produção, consumo, esmagamento, exportações, importações e estoques.</p>
            <p>Para análise de preço, acompanhe principalmente estoque/uso, ritmo de exportação,
            crescimento do esmagamento, China nas importações e concentração do market share global.</p>
        </div>
        """, unsafe_allow_html=True)
